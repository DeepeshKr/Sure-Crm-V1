...
ActiveRecord::Schema.define(version: 20160121165950) do
  ...
  create_table "bootsy_image_galleries", force: true do |t|
    t.integer  "bootsy_resource_id",   limit: nil, precision: 38
  ...
  create_table "bootsy_images", force: true do |t|
    t.string   "image_file"
    t.integer  "image_gallery_id", limit: nil, precision: 38
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "campaign_missed_lists", force: true do |t|
    t.integer  "product_list_id",      limit: nil, precision: 38
    t.integer  "product_variant_id",   limit: nil, precision: 38
    t.integer  "productmaster_id",     limit: nil, precision: 38
    ...
    t.integer  "order_id",             limit: nil, precision: 38
  ...
  create_table "campaign_playlists", force: true do |t|
    ...
    t.datetime "for_date"
    t.integer  "total_revenue",     limit: nil, precision: 38
    t.integer  "playlist_group_id", limit: nil, precision: 38
    t.integer  "start_frame",       limit: nil, precision: 38
    t.integer  "end_frame",         limit: nil, precision: 38
  end
  ...
  create_table "campaigns", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "total_cost",    limit: nil, precision: 38
    t.integer  "total_revenue", limit: nil, precision: 38
  end
  ...
  create_table "corporate_active_masters", force: true do |t|
    t.string   "name"
  ...
  create_table "corporates", force: true do |t|
    ...
    t.integer  "active",             limit: nil, precision: 38
    t.string   "tally_id"
    t.string   "c_form"
    t.string   "cst_no"
    t.string   "gst_no"
    ...
    t.integer  "web_id",             limit: nil, precision: 38
    t.integer  "ref_no",             limit: nil, precision: 38
    t.decimal  "commission_percent",             precision: 5,  scale: 4
    t.string   "pan_card_no"
  end

  create_table "courier_lists", force: true do |t|
    t.string   "name"
    t.text     "description"
  ...
  create_table "distributor_missed_order_types", force: true do |t|
    t.string   "name"
    t.integer  "sort_order",  limit: nil, precision: 38
    t.text     "description"
    t.datetime "created_at",                             null: false
  ...
  create_table "distributor_missed_orders", force: true do |t|
    t.integer  "corporate_id",   limit: nil, precision: 38
    t.integer  "missed_type_id", limit: nil, precision: 38
    t.integer  "order_value",    limit: nil, precision: 38
    t.integer  "order_no",       limit: nil, precision: 38
    t.integer  "order_id",       limit: nil, precision: 38
    t.text     "description"
    t.datetime "created_at",                                null: false
    t.datetime "updated_at",                                null: false
  ...
  create_table "distributor_missed_pincodes", force: true do |t|
    t.string   "pincode"
    t.integer  "no_of_orders", limit: nil, precision: 38
  ...
  create_table "distributor_pincode_lists", force: true do |t|
    t.string   "city"
    t.string   "state"
    t.string   "locality"
    t.integer  "sort_order",   limit: nil, precision: 38
  ...
  create_table "distributor_product_lists", force: true do |t|
    t.integer  "product_list_id", limit: nil, precision: 38
    t.string   "name"
    t.integer  "sort_order",      limit: nil, precision: 38
    t.datetime "created_at",                                 null: false
  ...
  create_table "distributor_stock_books", force: true do |t|
    t.integer  "corporate_id",       limit: nil, precision: 38
    ...
    t.integer  "sold_qty",           limit: nil, precision: 38
    t.decimal  "sold_value",                     precision: 10, scale: 2
    t.integer  "return_qty",         limit: nil, precision: 38
  ...
  create_table "distributor_stock_ledger_types", force: true do |t|
    t.string   "name"
    t.integer  "sort_order",  limit: nil, precision: 38
    t.text     "description"
    t.datetime "created_at",                             null: false
  ...
  create_table "distributor_stock_ledgers", force: true do |t|
    t.integer  "corporate_id",       limit: nil, precision: 38
    t.integer  "product_master_id",  limit: nil, precision: 38
    t.integer  "product_variant_id", limit: nil, precision: 38
    t.integer  "product_list_id",    limit: nil, precision: 38
    ...
    t.datetime "created_at",                                              null: false
    t.datetime "updated_at",                                              null: false
    t.integer  "type_id",            limit: nil, precision: 38
    t.decimal  "stock_value",                    precision: 10, scale: 2
  end

  create_table "distributor_stock_summaries", force: true do |t|
    t.integer  "corporate_id",       limit: nil, precision: 38
    t.integer  "product_master_id",  limit: nil, precision: 38
    t.integer  "product_variant_id", limit: nil, precision: 38
    t.integer  "product_list_id",    limit: nil, precision: 38
    t.string   "prod"
    t.integer  "stock_qty",          limit: nil, precision: 38
    t.integer  "stock_value",        limit: nil, precision: 38
    t.integer  "stock_returned",     limit: nil, precision: 38
    t.datetime "summary_date"
    t.datetime "created_at",                                    null: false
    t.datetime "updated_at",                                    null: false
  end

  create_table "distributor_upload_orders", force: true do |t|
    t.integer  "order_id",           limit: nil, precision: 38
    t.integer  "ext_order_id",       limit: nil, precision: 38
    t.datetime "last_ran_on"
    t.text     "description"
    t.integer  "online_order_id",    limit: nil, precision: 38
  ...
  create_table "errors", force: true do |t|
    ...
    t.integer  "usable_id",   limit: nil, precision: 38
    t.text     "class_name"
    t.text     "message"
    t.text     "trace"
    t.text     "target_url"
  ...
  create_table "fedex_bill_checks", force: true do |t|
    t.integer  "shp_cust_nbr",                   limit: nil, precision: 38
    t.integer  "acctno",                         limit: nil, precision: 38
    t.integer  "invno",                          limit: nil, precision: 38
    t.datetime "invdate"
    t.integer  "awb",                            limit: nil, precision: 38
    t.datetime "shipdate"
    t.string   "shprname"
    t.string   "coname"
    t.string   "shipadd"
    ...
    t.integer  "svc1",                           limit: nil, precision: 38
    t.integer  "pcs",                            limit: nil, precision: 38
    t.integer  "weight",                         limit: nil, precision: 38
    t.integer  "dimwgt",                         limit: nil, precision: 38
    ...
    t.string   "verif_name"
    t.integer  "verif_order_ref_id",             limit: nil, precision: 38
    t.integer  "verif_order_no",                 limit: nil, precision: 38
    t.string   "verif_products"
    t.integer  "verif_weight",                   limit: nil, precision: 38
    t.integer  "verif_weight_diff",              limit: nil, precision: 38
  ...
  create_table "help_files", force: true do |t|
    t.string   "name"
    t.string   "link"
    t.text     "description"
    t.text     "code_used"
  ...
  create_table "media", force: true do |t|
    ...
    t.string   "channel"
    t.string   "slot"
    t.integer  "daily_charges",      limit: nil, precision: 38
  ...
  create_table "media_tapes", force: true do |t|
    ...
    t.integer  "sort_order",         limit: nil, precision: 38
    t.integer  "frames",             limit: nil, precision: 38
  end

  create_table "message_on_orders", force: true do |t|
    t.integer  "customer_id",       limit: nil, precision: 38
    t.integer  "message_type_id",   limit: nil, precision: 38
    t.integer  "message_status_id", limit: nil, precision: 38
    t.string   "message"
    t.string   "response"
    t.string   "mobile_no"
  ...
  create_table "order_final_statuses", force: true do |t|
    t.string   "name"
    t.integer  "sort_order",  limit: nil, precision: 38
    t.text     "description"
    t.datetime "created_at",                             null: false
  ...
  create_table "order_list_miles", force: true do |t|
    t.string   "name"
    t.integer  "sort_order",  limit: nil, precision: 38
    t.text     "description"
    t.datetime "created_at",                             null: false
  ...
  create_table "order_masters", force: true do |t|
    ...
    t.string   "sessionid"
    t.string   "mobile"
    t.integer  "original_order_id",      limit: nil, precision: 38
    t.integer  "promotion_id",           limit: nil, precision: 38
    t.string   "city"
    t.string   "pincode"
    t.integer  "order_last_mile_id",     limit: nil, precision: 38
    t.integer  "order_final_status_id",  limit: nil, precision: 38
    t.decimal  "g_total",                            precision: 12, scale: 2
    t.integer  "weight_kg",              limit: nil, precision: 38
  end
  ...
  create_table "order_updates", force: true do |t|
    t.integer  "order_id",      limit: nil, precision: 38
    t.integer  "order_line_id", limit: nil, precision: 38
  ...
  create_table "page_trails", force: true do |t|
    t.string   "name"
    t.integer  "order_id",      limit: nil, precision: 38
  ...
  create_table "pincode_service_levels", force: true do |t|
    t.string   "pincode"
    t.integer  "total_orders",      limit: nil, precision: 38
    t.decimal  "total_value"
    t.datetime "last_ran_on"
    t.text     "description"
    t.integer  "courier_id",        limit: nil, precision: 38
    t.integer  "time_to_deliver",   limit: nil, precision: 38
    t.integer  "cod_avail",         limit: nil, precision: 38
    t.integer  "distributor_avail", limit: nil, precision: 38
    t.integer  "paid_order",        limit: nil, precision: 38
  ...
  create_table "product_cost_masters", force: true do |t|
    t.integer  "product_id",              limit: nil, precision: 38
    t.integer  "product_list_id",         limit: nil, precision: 38
    t.string   "prod"
    t.string   "barcode"
    t.integer  "product_cost",            limit: nil, precision: 38
    t.integer  "basic_cost",              limit: nil, precision: 38
    t.integer  "shipping_handling",       limit: nil, precision: 38
    t.integer  "postage",                 limit: nil, precision: 38
    t.integer  "tel_cost",                limit: nil, precision: 38
    t.integer  "transf_order_basic",      limit: nil, precision: 38
    t.integer  "dealer_network_basic",    limit: nil, precision: 38
    t.integer  "wholesale_variable_cost", limit: nil, precision: 38
    t.integer  "royalty",                 limit: nil, precision: 38
    t.integer  "cost_of_return",          limit: nil, precision: 38
    t.integer  "call_centre_commission",  limit: nil, precision: 38
    t.datetime "created_at",                                         null: false
    t.datetime "updated_at",                                         null: false
    t.integer  "cost",                    limit: nil, precision: 38
    t.integer  "revenue",                 limit: nil, precision: 38
  end
  ...
  create_table "product_master_add_ons", force: true do |t|
    ...
    t.datetime "updated_at",                                       null: false
    t.integer  "sort_order",            limit: nil, precision: 38
    t.integer  "replace_by_product_id", limit: nil, precision: 38
  end
  ...
  create_table "product_masters", force: true do |t|
    ...
    t.integer  "sel_cod",                limit: nil, precision: 38
    t.integer  "sel_s_tax",              limit: nil, precision: 38
    t.integer  "sel_m_cod",              limit: nil, precision: 38
    t.integer  "sel_m_cc",               limit: nil, precision: 38
    t.integer  "sel_cc",                 limit: nil, precision: 38
  end

  add_index "product_masters", ["extproductcode"], name: "i_pro_mas_ext"

  create_table "product_sample_stocks", force: true do |t|
    t.integer  "product_master_id", limit: nil, precision: 38
    t.integer  "product_list_id",   limit: nil, precision: 38
    ...
    t.decimal  "shipping"
    t.datetime "air_date"
    t.integer  "orders",            limit: nil, precision: 38
    t.integer  "stock",             limit: nil, precision: 38
    t.text     "description"
    t.datetime "created_at",                                   null: false
    t.datetime "updated_at",                                   null: false
  end
  ...
  create_table "product_test_ppos", force: true do |t|
    t.string   "name"
    t.string   "prod_code"
    t.string   "barcode"
    t.decimal  "basic_price"
  ...
  create_table "promotions", force: true do |t|
    ...
    t.datetime "end_date"
    t.integer  "media_id",             limit: nil, precision: 38
    t.integer  "min_sale_value",       limit: nil, precision: 38
    t.decimal  "discount_percent",                 precision: 4,  scale: 4
    t.integer  "discount_value",       limit: nil, precision: 38
    t.integer  "free_product_list_id", limit: nil, precision: 38
    t.integer  "active",               limit: nil, precision: 38
  ...
  create_table "sales_ppos", force: true do |t|
    t.integer  "campaign_playlist_id", limit: nil, precision: 38
    t.integer  "campaign_id",          limit: nil, precision: 38
    t.integer  "product_master_id",    limit: nil, precision: 38
    t.integer  "product_variant_id",   limit: nil, precision: 38
    ...
    t.integer  "pieces",               limit: nil, precision: 38
    t.integer  "revenue",              limit: nil, precision: 38
    t.integer  "damages",              limit: nil, precision: 38
    t.integer  "returns",              limit: nil, precision: 38
    t.integer  "commission_cost",      limit: nil, precision: 38
    t.integer  "promotion_cost",       limit: nil, precision: 38
    t.integer  "gross_sales",          limit: nil, precision: 38
    t.integer  "net_sale",             limit: nil, precision: 38
    t.integer  "external_order_no",    limit: nil, precision: 38
    t.integer  "order_status_id",      limit: nil, precision: 38
    t.integer  "order_last_mile_id",   limit: nil, precision: 38
    t.string   "order_pincode"
    t.integer  "media_id",             limit: nil, precision: 38
    t.integer  "promo_cost_total",     limit: nil, precision: 38
    t.string   "dnis"
    t.string   "city"
    t.string   "state"
    t.string   "mobile_no"
  ...
  create_table "transfer_order_lines", force: true do |t|
    t.integer  "transfer_order_id",        limit: nil, precision: 38
    t.string   "prod"
    t.text     "description"
    t.integer  "product_list_id",          limit: nil, precision: 38
    t.integer  "product_variant_id",       limit: nil, precision: 38
    t.integer  "product_master_id",        limit: nil, precision: 38
    t.integer  "pieces",                   limit: nil, precision: 38
    t.integer  "sub_total",                limit: nil, precision: 38
    t.integer  "shipping",                 limit: nil, precision: 38
    t.integer  "codcharges",               limit: nil, precision: 38
    t.integer  "total",                    limit: nil, precision: 38
    t.integer  "transfer_order_status_id", limit: nil, precision: 38
    t.text     "notes"
    t.datetime "created_at",                                          null: false
    t.datetime "updated_at",                                          null: false
  end

  create_table "transfer_order_masters", force: true do |t|
    t.integer  "corporate_id",             limit: nil, precision: 38
    t.datetime "orderdate"
    t.integer  "customer_id",              limit: nil, precision: 38
    t.integer  "order_id",                 limit: nil, precision: 38
    ...
    t.integer  "codcharges",               limit: nil, precision: 38
    t.integer  "total",                    limit: nil, precision: 38
    t.integer  "g_total",                  limit: nil, precision: 38
    t.integer  "transfer_order_status_id", limit: nil, precision: 38
    t.text     "notes"
    t.datetime "created_at",                                          null: false
    t.datetime "updated_at",                                          null: false
  ...
  create_table "transfer_order_statuses", force: true do |t|
    t.string   "name"
    t.integer  "sort_order",  limit: nil, precision: 38
    t.text     "description"
    t.datetime "created_at",                             null: false
  ...
  create_table "vpp_deal_trans", force: true do |t|
    t.datetime "actdate"
    ...
    t.integer  "channel",               limit: nil, precision: 3
    t.string   "city",                  limit: 20
    t.datetime "claimdate"
    t.decimal  "codamt",                            precision: 8,  scale: 2
    t.decimal  "convcharges",                       precision: 8,  scale: 2
    t.string   "cou",                   limit: 1
    t.integer  "custref",               limit: nil, precision: 12
    t.integer  "debitnote",             limit: nil, precision: 5
    ...
    t.integer  "distcode",              limit: nil, precision: 10
    ...
    t.datetime "moddt"
    t.boolean  "notice"
    t.integer  "normal",                limit: nil, precision: 6
    t.integer  "operator",              limit: nil, precision: 3
    t.string   "order_number",          limit: 15
    t.datetime "orderdate"
    t.string   "orderno",               limit: 15
    t.string   "ordersource",           limit: 1
    t.integer  "paidamt",               limit: nil, precision: 6
    t.datetime "paiddate"
    t.string   "ordertype",             limit: 1
    t.integer  "pin",                   limit: nil, precision: 6
    t.integer  "postage",               limit: nil, precision: 5
    t.datetime "probag"
    t.string   "prod",                  limit: 6
    t.integer  "qty",                   limit: nil, precision: 2
    t.string   "remarks",               limit: 1
    t.integer  "refundamt",             limit: nil, precision: 5
    t.string   "refundcheck",           limit: 10
    t.datetime "refundcheckdate"
    t.datetime "refunddate"
    t.datetime "returndate"
    t.integer  "sanction",              limit: nil, precision: 5
    t.datetime "shdate"
    t.boolean  "shipped"
    t.string   "state",                 limit: 3
    t.string   "status",                limit: 20
    t.datetime "statusdate"
    t.integer  "taxamt",                limit: nil, precision: 5
    ...
    t.integer  "invoicerefno",          limit: nil, precision: 12
    t.text     "description"
    t.integer  "order_last_mile_id",    limit: nil, precision: 38
    t.integer  "order_final_status_id", limit: nil, precision: 6
    t.datetime "created_at",                                                 null: false
    t.datetime "updated_at",                                                 null: false
  end
