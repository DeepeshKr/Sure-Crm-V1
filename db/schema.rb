...
ActiveRecord::Schema.define(version: 20160223064017) do
...
# Could not dump table "product_stocks" because of following ActiveRecord::StatementInvalid
#   OCIError: ORA-03113: end-of-file on communication channel
Process ID: 1382
Session ID: 256 Serial number: 140733193422574:             SELECT comments FROM all_col_comments
            WHERE owner = 'TESTORA'
