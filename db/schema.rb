...
ActiveRecord::Schema.define(version: 20160128063414) do
  ...
  create_table "fat_to_fit_email_statuses", force: :cascade do |t|
    ...
    t.integer  "order_no",               limit: 16, precision: 38
    t.integer  "order_id",               limit: 16, precision: 38
    t.integer  "send_status",            limit: 16, precision: 38
    ...
    t.string   "state"
    t.string   "city"
    t.integer  "registration_status_id", limit: 16, precision: 38
  end
  ...
  create_table "transfer_order_lines", force: :cascade do |t|
    t.integer  "transfer_order_id",        limit: 16, precision: 38
    t.string   "prod"
    t.text     "description"
    t.integer  "product_list_id",          limit: 16, precision: 38
    t.integer  "product_variant_id",       limit: 16, precision: 38
    t.integer  "product_master_id",        limit: 16, precision: 38
    t.integer  "pieces",                   limit: 16, precision: 38
    t.integer  "sub_total",                limit: 16, precision: 38
    t.integer  "shipping",                 limit: 16, precision: 38
    t.integer  "codcharges",               limit: 16, precision: 38
    t.integer  "total",                    limit: 16, precision: 38
    t.integer  "transfer_order_status_id", limit: 16, precision: 38
    t.text     "notes"
    t.datetime "created_at",                                         null: false
    t.datetime "updated_at",                                         null: false
  end
  ...
  create_table "transfer_order_masters", force: :cascade do |t|
    ...
    t.integer  "codcharges",               limit: 16, precision: 38
    t.integer  "total",                    limit: 16, precision: 38
    t.integer  "g_total",                  limit: 16, precision: 38
    t.integer  "transfer_order_status_id", limit: 16, precision: 38
    t.text     "notes"
    t.datetime "created_at",                                         null: false
    t.datetime "updated_at",                                         null: false
