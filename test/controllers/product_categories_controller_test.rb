...
class ProductCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create product_category" do
    assert_difference('ProductCategory.count') do
      post :create, product_category: { description: @product_category.description, name: @product_category.name, vatpercent: @product_category.vatpercent }
    end
  ...
  test "should update product_category" do
    patch :update, id: @product_category, product_category: { description: @product_category.description, name: @product_category.name, vatpercent: @product_category.vatpercent }
    assert_redirected_to product_category_path(assigns(:product_category))
  end
