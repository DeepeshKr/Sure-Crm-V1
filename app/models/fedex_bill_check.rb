...
#use this to open file
  ...
  def self.calculate_fedex_billing(weight)
    ...
    fedex_bill.basic = 80 if (weight * 8) < 80
    fedex_bill.fuel_surcharge =  fedex_bill.basic * 0.2
    fedex_bill.cod = 50
    fedex_bill.sub_total = fedex_bill.basic + fedex_bill.cod + fedex_bill.fuel_surcharge
