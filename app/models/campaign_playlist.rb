class CampaignPlaylist < ActiveRecord::Base
 ...
 has_many :order_master, foreign_key: "campaign_playlist_id"
  ...
  # validates :start_frame, :inclusion => { :in => 1..24, :message => "The hours should be between 0 and 24" }, presence: false
  # validates :end_frame, :inclusion => { :in => 1..24, :message => "The hours should be between 0 and 24" }, presence: false
